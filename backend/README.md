...
## Project Structure
    ...
    ├── ideapros_llc_home_s_32960  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_home_s_32960`
...
2. Clone this repo and `cd ideapros_llc_home_s_32960`
